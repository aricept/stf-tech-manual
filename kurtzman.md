...
The shuttlebay launch doors occupy the entire rear hull plates of the star drive and comprise two separate units. The outer shuttlebay doors
(the outer hull section) are withdrawn upwards into a dedicated space between the primary and secondary hulls. The segmented inner doors then retract horizontally, withdrawing along the back wall of the shuttlebay. Atmospheric shields engage when the inner doors are withdrawn, allowing environmental integrity to be maintained.
